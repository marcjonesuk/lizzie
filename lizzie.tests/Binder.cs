...
//         [Test]
//         public async Task StaticFunctions()
//         {
...
//             protected async Task<object> ExtendedFunction(Binder<SimpleValues> ctx, Arguments arguments)
//             {
...
//             async Task<object> ExtendedFunction2(Binder<SimpleValues> ctx, Arguments arguments)
//             {
...
//         [Test]
//         public async Task ExtendedClassShallowBind()
//         {
...
//         [Test]
//         public async Task ExtendedClassDeepBind()
//         {
//             SimpleValues simple = new SimpleValueExtended();
...
//         [Test]
//         public async Task ExtendedClassDeepBindInvokeInheritedPublicMethod()
//         {
//             SimpleValues simple = new SimpleValueExtended();
...
//         [Test]
//         public async Task ExtendedClassDeepBindInvokeInheritedProtectedMethod()
//         {
//             SimpleValues simple = new SimpleValueExtended();
...
//         [Test]
//         public async Task ExtendedClassDeepBindInvokeInheritedStaticMethod()
//         {
//             SimpleValues simple = new SimpleValueExtended();
...
//         [Test]
//         public async Task DoubleExtendedClassDeepBindInvokeInheritedStaticMethod()
//         {
...
//         {
//             [Bind(Name = "foo")]
//             protected virtual async Task<object> Foo(Binder<BaseClass1> ctx, Arguments arguments)
//             {
//                 return 57;
//             }
//         }
...
//         {
//             [Bind(Name = "foo")]
//             protected override async Task<object> Foo(Binder<BaseClass1> ctx, Arguments arguments)
//             {
//                 return 77;
//             }
//         }
...
//         [Test]
//         public async Task VirtualInheritedDeeplyBound()
//         {
...
//         {
//             [Bind(Name = "foo1")]
//             protected async Task<object> Foo1(Binder<BaseClass2> ctx, Arguments arguments)
//             {
//                 return 50;
//             }
//         }
...
//         {
//             [Bind(Name = "foo2")]
//             async Task<object> Foo2(Binder<BaseClass2> ctx, Arguments arguments)
//             {
//                 return 7;
//             }
//         }
...
//         [Test]
//         public async Task InvokingFromBothSuperAndBase()
//         {
...
//         {
//             [Bind(Name = "foo1")]
//             protected async Task<object> Foo1(Binder<BaseClass3> ctx, Arguments arguments)
//             {
//                 return 50;
//             }

//             [Bind(Name = "foo2")]
//             protected static async Task<object> Foo2(BaseClass3 context, Binder<BaseClass3> ctx, Arguments arguments)
//             {
//                 return 5;
//             }
//         }
...
//         {
//             [Bind(Name = "foo3")]
//             protected async Task<object> Foo3(Binder<BaseClass3> ctx, Arguments arguments)
//             {
//                 return 7;
//             }

//             [Bind(Name = "foo4")]
//             protected static async Task<object> Foo4(BaseClass3 context, Binder<BaseClass3> ctx, Arguments arguments)
//             {
//                 return 4;
//             }
//         }
...
//         {
//             [Bind(Name = "foo5")]
//             async Task<object> Foo5(Binder<BaseClass3> ctx, Arguments arguments)
//             {
//                 return 1;
//             }
//         }
...
//         [Test]
//         public async Task InvokingFromBothSuperAndBaseInstanceAndStatic()
//         {
