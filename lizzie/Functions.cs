...
namespace lizzie
{
    ...
    public static class Functions<TContext>
    {
        ...
        public static Function<TContext> Var => new Function<TContext>(async (ctx, binder, arguments) =>
        {
        ...
        public static Function<TContext> Set => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking invocation.
            if (arguments.Count == 0)
        ...
        public static Function<TContext> Subtract => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
        ...
        public static Function<TContext> Multiply => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
            if (arguments.Count < 2)
        ...
        public static Function<TContext> Divide => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
            if (arguments.Count < 2)
        ...
        public static Function<TContext> Modulo => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
            if (arguments.Count < 2)
        ...
        public static Function<TContext> Function => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
            if (arguments.Count == 0)
        ...
        public static Function<TContext> Apply => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking invocation.
            if (arguments.Count != 1)
        ...
        public static Function<TContext> If => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
            if (arguments.Count < 2)
            ...
            if (condition != null)
            {
                ...
                return await lambdaIf(ctx, binder, arguments);
            }
            ...
            if (arguments.Count > 2)
            {
                ...
                return await lambdaElse(ctx, binder, arguments);
            }
        ...
        public static Function<TContext> Eq => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count < 2)
        ...
        public static Function<TContext> Mt => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 2)
        ...
        public static Function<TContext> Lt => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 2)
        ...
        public static Function<TContext> Mte => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 2)
        ...
        public static Function<TContext> Lte => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 2)
                throw new LizzieRuntimeException("The 'less than' function must be given exactly 2 arguments.");
            dynamic arg1 = arguments.Get(0);
        ...
        public static Function<TContext> Not => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 1)
        ...
        public static Function<TContext> Any => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            /*
        ...
        public static Function<TContext> All => new Function<TContext>(async (ctx, binder, arguments) =>
        {
        ...
        public static Function<TContext> List => new Function<TContext>(async (ctx, binder, arguments) =>
        {
        ...
        public static Function<TContext> Count => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 1)
        ...
        public static Function<TContext> Get => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 2)
        ...
        /// </summary>
        /// <value>The function wrapping the 'add keyword'.</value>
        public static Function<TContext> AddValue => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count < 2)
        ...
        public static Function<TContext> Slice => new Function<TContext>(async (ctx, binder, arguments) =>
        {
        ...
        public static Function<TContext> Each => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking code.
        ...
        public static Function<TContext> Map => new Function<TContext>(async (ctx, binder, arguments) =>
        {
        ...
        public static Function<TContext> Json => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 1)
        ...
        public static Function<TContext> String => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 1)
        ...
        public static Function<TContext> Number => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            if (arguments.Count != 1)
        ...
        public static Function<TContext> Substr => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking.
            if (arguments.Count < 2)
        ...
        public static Function<TContext> Length => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking.
            if (arguments.Count != 1)
        ...
        public static Function<TContext> Replace => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking.
            if (arguments.Count != 3)
        ...
        public static Function<TContext> Eval => new Function<TContext>(async (ctx, binder, arguments) =>
        {
            // Sanity checking.
            if (arguments.Count != 1)
